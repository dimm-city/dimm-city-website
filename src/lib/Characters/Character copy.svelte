			...
			<div class="container">
				...
				<div class="image">
					<!-- <img
						...
						alt=""
					/> -->
					<img src={character.thumbnail_uri} alt="character portrait" />
				</div>

				<div>
					Racial Abilities
					<ul>
						{#if character.race && character.race.abilities}
							{#each character.race.abilities as ability}
								<li class="small-menu-item" data-augmented-ui>
									<a href="#{ability.slug}"> {ability.name}</a>
								</li>
							{/each}
						{/if}
					</ul>
				...
				<div>
					...
					<ul class="aug-list">
						{#if character.cybernetics}
							{#each character.cybernetics as ability}
								<li class="small-menu-item" data-augmented-ui>
									<a href="#{ability.slug}"> {ability.name}</a>
								</li>
							{/each}
				...
				<div class="abilities">
					...
					<ul>
						{#if character.selectedAbilities}
							{#each character.selectedAbilities as ability}
								<li class="small-menu-item" data-augmented-ui>
									<a href="#{ability.slug}"> {ability.name}</a>
								</li>
							{/each}
